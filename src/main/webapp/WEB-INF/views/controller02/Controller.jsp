...
<body>
	...
	<div class="container">
		...
		<fieldset>
			...
			<h2>하나의 컨트롤러 메소드로 여러 요청처리하기-String[]사용</h2>
			<ul style="list-style: upper-roman;">
			...
			<h2>하나의 컨트롤러 메소드로 여러 요청처리하기-URL패턴상의 패스로 구분</h2>
			<ul style="list-style: upper-roman;">
